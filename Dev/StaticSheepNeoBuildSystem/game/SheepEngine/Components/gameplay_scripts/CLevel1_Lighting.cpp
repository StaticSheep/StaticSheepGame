...
namespace Framework
{
  ...
  void Level1_Lighting::LogicUpdate(float dt)
  {
    ...
    else
    {
      ...
      space->GetGameObject(m_lights[4])->GetComponent<PointLight>(ePointLight)->m_brightness.a = Ease::Linear(m_PulseT, 800.0f, 2000.0f);
      space->GetGameObject(m_lights[5])->GetComponent<PointLight>(ePointLight)->m_brightness.a = Ease::Linear(m_PulseT, 800.0f, 2000.0f);
