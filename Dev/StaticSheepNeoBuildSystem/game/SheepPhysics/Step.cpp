...
namespace SheepFizz
{
  //Nocollide, Collide, Resolve, Player1, Player2, Player3, Player4, Player1Weapon, Player2Weapon, Player3Weapon, Player4Weapon, Item, Static
  Collision Collisions[CollGroupLength][CollGroupLength] = { 
      //NoCollide  Collide    Resolve     Player1     Player2     Player3     Player4     Player1Weapon Player2Weapon Player3Weapon Player4Weapon Item        Static
      { NOCOLLIDE, NOCOLLIDE, NOCOLLIDE,  NOCOLLIDE,  NOCOLLIDE,  NOCOLLIDE,  NOCOLLIDE,  NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  NOCOLLIDE },    //NoCollide
      { NOCOLLIDE, NOCOLLIDE, COLLIDE,    COLLIDE,    COLLIDE,    COLLIDE,    COLLIDE,    COLLIDE,      COLLIDE,      COLLIDE,      COLLIDE,      COLLIDE,    COLLIDE   },    //Collide
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,      RESOLVE,      RESOLVE,      RESOLVE,      RESOLVE,    RESOLVE   },    //Resolve
      { NOCOLLIDE, COLLIDE,   RESOLVE,    NOCOLLIDE,  RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,    RESOLVE,      RESOLVE,      RESOLVE,      RESOLVE,    RESOLVE   },    //Player1
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    NOCOLLIDE,  RESOLVE,    RESOLVE,    RESOLVE,      NOCOLLIDE,    RESOLVE,      RESOLVE,      RESOLVE,    RESOLVE   },    //Player2
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,  RESOLVE,    RESOLVE,      RESOLVE,      NOCOLLIDE,    RESOLVE,      RESOLVE,    RESOLVE   },    //Player3
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,  RESOLVE,      RESOLVE,      RESOLVE,      NOCOLLIDE,    RESOLVE,    RESOLVE   },    //Player4
      { NOCOLLIDE, COLLIDE,   RESOLVE,    NOCOLLIDE,  RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  RESOLVE   },    //Player1Weapon
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    NOCOLLIDE,  RESOLVE,    RESOLVE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  RESOLVE   },    //Player2Weapon
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,  RESOLVE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  RESOLVE   },    //Player3Weapon
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,  NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  RESOLVE   },    //Player4Weapon
      { NOCOLLIDE, COLLIDE,   RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    NOCOLLIDE,  NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,    NOCOLLIDE,  RESOLVE   },    //Item
      { NOCOLLIDE, NOCOLLIDE, RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,    RESOLVE,      RESOLVE,      RESOLVE,      RESOLVE,      RESOLVE,    NOCOLLIDE } };//Static
