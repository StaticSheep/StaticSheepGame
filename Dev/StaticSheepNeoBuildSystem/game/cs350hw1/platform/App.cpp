...
#pragma region Hw1Window implementation
    ...
    void Hw1Window::OnOpenFile(wxCommandEvent& event)
    {
        wxFileDialog ofd {
        this
        , "Open XYZ file"
        ...
        auto loadFn = [=]() {
            ...
            auto msp = std::make_shared<HalfEdgeMesh>();
            msp.reset(mesh);
    ...
    void Hw1Window::OnExit(wxCommandEvent& event)
    {
        this->Close();
    }
    ...
    void Hw1Window::OnPropGridChanging(wxPropertyGridEvent& event)
    {
        event.Veto();
    }
    ...
    void Hw1Window::OnFlagSolidMesh(wxCommandEvent& event)
    {
    ...
    void Hw1Window::OnFlagDrawHoles(wxCommandEvent& event)
    {
    ...
    void Hw1Window::OnFlagCoordFrame(wxCommandEvent& event)
    {
...
#pragma region Common interface
    ...
    void App::InitGfx()
    {
        ...
        // create the window
        auto hw1 = new Hw1Window{ nullptr, input };
        int32 width = 0, height = 0;
        hw1->GetClientSize(&width, &height);
        auto gwp = hw1->gameWindowPanel;

        window = new WxWindow{ { (uint16) width, (uint16) height, String{ hw1->GetTitle().c_str() }, hw1 }, hw1, input };
    ...
    void App::InitEvents()
    {
        ...
        // mesh loading
        std::function<void(HalfEdgeMeshPtr, String)> onMeshLoaded = [&](HalfEdgeMeshPtr mesh, String path) {
