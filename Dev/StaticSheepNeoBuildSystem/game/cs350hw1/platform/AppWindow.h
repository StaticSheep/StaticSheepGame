...
namespace dit
{
	...
	class AppWindow : public wxFrame 
	{
		...
		protected:
			...
			virtual void OnFlagDrawHoles( wxCommandEvent& event ) { event.Skip(); }
		...
		public:
			...
			wxCheckBox* drawHolesCheckbox;
			wxCheckBox* triangleStripCheckbox;
			wxCheckBox* coordFrameCheckbox;
			wxPanel* gameWindowPanel;
			
			AppWindow( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("chart - cs350su14: hw1"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1280,720 ), long style = wxDEFAULT_FRAME_STYLE|wxFULL_REPAINT_ON_RESIZE|wxTAB_TRAVERSAL|wxWANTS_CHARS );
