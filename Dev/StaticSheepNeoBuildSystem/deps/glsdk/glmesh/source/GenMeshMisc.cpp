...
namespace gen
{
	Mesh *FullScreenQuad()
	{
		VertexFormat fmt{ { { ATTR_POS, 2, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT } } };
	...
	Mesh * GroundPlane( int numXVerts, int numYVerts, bool bDoubleSided )
	{
		...
		VertexFormat fmt{ {
				{ ATTR_POS, 2, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT }
				, { ATTR_NORMAL, 4, glmesh::VDT_SIGN_BYTE, glmesh::ADT_NORM_FLOAT }
				, { ATTR_TEXCOORD, 2, glmesh::VDT_UNSIGN_SHORT, glmesh::ADT_NORM_FLOAT } } };
	...
	Mesh * Axes( ColorArray colorSequence )
	{
		...
		VertexFormat fmt{ { 
			{ ATTR_POS, 3, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT }
			, { ATTR_COLOR, 4, glmesh::VDT_UNSIGN_BYTE, glmesh::ADT_NORM_FLOAT } } };
	...
	Mesh * CubeBlock( int numCubesOnEdge, const ColorArray &colorSequence )
	{
		...
		{
			fmt = { {
				{ ATTR_POS, 3, glmesh::VDT_SIGN_SHORT, glmesh::ADT_FLOAT }
				, { ATTR_NORMAL, 4, glmesh::VDT_SIGN_BYTE, glmesh::ADT_NORM_FLOAT }
				, { ATTR_COLOR, 4, glmesh::VDT_UNSIGN_BYTE, glmesh::ADT_NORM_FLOAT } } };
		}
		else
