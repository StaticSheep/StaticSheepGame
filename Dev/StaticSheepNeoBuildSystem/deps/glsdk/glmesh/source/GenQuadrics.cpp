...
namespace glmesh
{
	namespace gen
	{
		...
		Mesh * UnitSphere( int numHorizSlices, int numVertSlices )
		{
			...
			VertexFormat fmt { {
				{ ATTR_POS, 3, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT }
				, { ATTR_NORMAL, 3, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT }
				, { ATTR_TEXCOORD, 2, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT } } };
